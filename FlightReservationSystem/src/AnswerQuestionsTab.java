    ...
    public static JPanel build(JFrame parentFrame, int empId) {
        ...
        replyButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow < 0) {
                    messageLabel.setText("Select a question to reply to.");
                    return;
                }
                ...
                if (answer.isEmpty()) {
                    messageLabel.setText("Answer cannot be empty.");
                    return;
                }

                try {
                    DBConnection.getStatement().executeUpdate("UPDATE Customer_Question SET " + "answer_text='" + answer.replace("'", "''") + "', " + "rep_id=" + empId + ", " + "answered_at=NOW() " + "WHERE question_id=" + questionId);
        ...
        topPanel.add(loadUnansweredButton);
        topPanel.add(loadAllButton);
        topPanel.add(replyButton);
