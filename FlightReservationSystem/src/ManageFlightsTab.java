...
public class ManageFlightsTab {
    ...
    public static JPanel build(JFrame parentFrame) {
        final String[] columns = {"Flight No", "Airline", "Aircraft", "From", "To", "Depart", "Arrive", "Intl", "Economy $", "Business $", "First $", "Stops"};
        ...
        editButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow < 0) { messageLabel.setText("Select a flight to edit."); return; }
        ...
        deleteButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int selectedRow = flightsTable.getSelectedRow();
                if (selectedRow < 0) { messageLabel.setText("Select a flight to delete."); return; }
                String flightNo  = (String) tableModel.getValueAt(selectedRow, 0);
                String airlineId = (String) tableModel.getValueAt(selectedRow, 1);
    ...
    static void loadAllFlights(DefaultTableModel tableModel, JLabel messageLabel) {
        ...
        try {
            ResultSet rs = DBConnection.getStatement().executeQuery(
                ...
                "base_economy_fare, base_business_fare, base_first_fare, stops FROM Flight ORDER BY airline_id, flight_no");
            while (rs.next()) {
                String isIntl;
    ...
    static void showFlightDialog(JFrame parentFrame, String flightNo, String airlineId,
                                  DefaultTableModel tableModel, JLabel messageLabel) {
        boolean isEdit = (flightNo != null);

        JTextField flightNoField  = new JTextField(flightNo != null ? flightNo : "", 8);
        JTextField airlineField   = new JTextField(airlineId != null ? airlineId : "", 4);
        ...
        if (isEdit) {
            ...
            try {
                ...
                ResultSet daysResult = DBConnection.getStatement().executeQuery(
        ...
        Object[] fields = {
            "Flight No:", flightNoField, "Airline ID:", airlineField,
            "Aircraft ID:", aircraftField, "From Airport:", fromField,
            "To Airport:", toField, "Dep Time (HH:MM):", depTimeField,
            "Arr Time (HH:MM):", arrTimeField, intlCheckBox,
            "Economy Fare:", ecoFareField, "Business Fare:", bizFareField,
            "First Fare:", fstFareField, "Stops:", stopsField,
        ...
        try {
            ...
            if (isEdit) {
                DBConnection.getStatement().executeUpdate(
                    ...
                    ", dep_airport_id='" + from + "', arr_airport_id='" + to +
